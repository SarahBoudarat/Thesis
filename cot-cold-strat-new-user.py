...
# Simulate cold-start: only top-3 rated movies per user in train set
...
for user_id in sampled_users_10:
    ...
    User’s Preferences:
    The user enjoys films with strong storytelling, emotional depth, and memorable characters. They have liked: {movie1}, {movie2}, and {movie3}.

    Chain of Thought:
    To recommend suitable movies, I’ll consider the user’s interest in engaging narratives and emotionally resonant stories. Given their past preferences, I’ll choose films that align in tone, theme, or character development.

    Recommendation (5 movie titles only, no numbering, no explanation):
    """
    ...
    try:
        ...
        print(f"\nUser {user_id} — Based on: {movie1}, {movie2}, {movie3}")
        print(f"Top-5 Recommendations: {recs[:5]}")
