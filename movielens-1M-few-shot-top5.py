...
log("EXPERIMENT Movie lens 1M: Few-Shot prompting for 100 users (≥100 ratings each).")
...
# -- Few-shot examples (static, but you can automate for personalization) --
few_shot_example = (
...
for user_id in sampled_users_100:
    ...
    prompt = (
        ...
        f"Recommend 5 movies I might enjoy. Just list the movie titles."
    )
