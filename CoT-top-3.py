...
log("EXPERIMENT SCALE-UP: Chain-of-Thought prompting (Top-3) for 100 users (≥50 ratings each).")
...
for user_id in sampled_users_100:
    top_movies = train_data_100[train_data_100["userId"] == user_id] \
                     .sort_values(by="timestamp")["title"].tolist()[-50:]
    ...
    prompt_text = (
        ...
        f"Let's think step by step based on the user's preferences. Identify genres, tone, and patterns from the movies above. Then recommend 3 suitable movies.\n\n"
