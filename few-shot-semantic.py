...
print("\nSemantic Evaluation Results for Few-Shot")
print("----------------------------------------")
...
# -----------------------------
with open("warm_start_few_shot_results.pkl", "wb") as f:
    pickle.dump({
...
if evaluation_results:
    print("\nAverage Evaluation Metrics for Warm-Start Few-Shot:")
