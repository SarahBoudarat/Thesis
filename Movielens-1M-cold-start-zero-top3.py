...
# SETUP
# -----------------------------
prompt_type = "cold_start_zero_shot_top3"
...
# -----------------------------
# SELECT TOP-3 HIGH-RATED MOVIES
# -----------------------------
...
# -----------------------------
# GPT PROMPTING (Top-3 Evaluation)
# -----------------------------
recommendations = {}
prompt_logs = []
...
print("\nAverage Evaluation Metrics (Cold-Start Zero-Shot - Top-3):")
